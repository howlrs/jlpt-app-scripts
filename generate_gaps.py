...
GAPS = [
    # === 赤色（緊急） ===
    ("n2", 17, "課題理解", 10, 150,
     "聴解の課題理解形式（下段）。まず質問を読み、その後音声を聞いて答える。具体的な行動や選択を求められる場面。日常・ビジネスの多様なシチュエーション。"),
    ("n5", 10, "文章の文法", 120, 300, ""),
    # === 黄色 ===
    ("n1", 11, "内容理解 (短文)", 195, 200, ""),
    ("n1", 10, "文章の文法", 227, 300, ""),
    ("n2", 10, "文章の文法", 174, 300, ""),
    ("n2", 16, "聴解", 133, 150,
     "聴解の課題理解形式（上段）。音声を聞いて要点・詳細・話し手の意図を把握する問題。"),
    ("n2", 17, "課題理解", 123, 150,
    ...
    ("n5", 16, "ポイント理解", 134, 150, ""),
    ("n5", 9, "文の文法2 (文の組み立て)", 254, 300, ""),
    ("n5", 14, "聴解", 144, 150,
     "音声を聞いて内容を理解する問題。簡単な会話・アナウンス。N5レベル。"),
    ("n5", 15, "課題理解", 144, 150, ""),
]
